 ...
 * @e_type: this is a pointer to the ELF type.
 * @e_ident: this is s pointer to an array containing the ELF class.
 */
 ...
 * @elf: this is a pointer to the file descriptor of the ELF file.
 *
 * Description: prints exit code 98 if the file cannot be closed.
 */
