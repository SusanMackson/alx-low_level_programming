 ...
 * @e_ident:t this is a pointer to an array containing the ELF magic numbers.
 *
 ...
 * @e_ident: Athis is apointer to an array containing the ELF magic numbers.
 *
 * Description: where the magic numbers are separated by spaces.
 */
void print_magic(unsigned char *e_ident)
{
	int index;
 ...
 * @e_ident: e_ident is a pointer to an array containing the ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
...
/**
 * print_type - thid function prints the type of an ELF header.
 * @e_type: e_type is the ELF type.
 * @e_ident: e_ident is a pointer to an array containing the ELF class.
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
{
 ...
 * @e_entry: e_entry is the address of the ELF entry point.
 * @e_ident: e_ident is a pointer to an array containing the ELF class.
 */
void print_entry(unsigned long int e_entry, unsigned char *e_ident)
{
 ...
 * @elf: elf is the file descriptor of the ELF file.
 *
 * Description: exit code 98 if the file cannot be close.
 */
void close_elf(int elf)
{
	if (close(elf) == -1)
 ...
 * @argv: argc is an array of pointers to the arguments.
 * Return: 0 on success.
 *
